...
set "OUTPUT=C:\Users\hojin\Downloads\PRAG_PROJ\ree_exporter\ch0000_split_motlists.fbx"
...
"%EXPORTER%" --mesh "%MESH%" --motlist-dir "%MOTLIST_DIR%" --split-motlists --no-placeholder-animation-bones --texture-format png --fbx-scale 100 --output "%OUTPUT%"
