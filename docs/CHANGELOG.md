...
- `Noise3D_00_MSK1` texture export errors remain warnings, including versioned `.tex.*` paths, because this known 3D noise texture is not supported by the TEX reader; all other texture export errors still fail the exporter.
