...
REM ch0100 single combined FBX export with all MOTLIST animations.
...
set "OUTPUT=C:\Users\hojin\Downloads\PRAG_PROJ\ree_exporter\ch0100_all_motlists_except_15_45.fbx"
...
"%EXPORTER%" --mesh "%MESH00%" --additional-mesh "%MESH10%" --additional-mesh "%MESH20%" --additional-mesh "%MESH40%" --motlist-dir "%MOTLIST_DIR%" --no-placeholder-animation-bones --texture-format png --fbx-scale 100 --output "%OUTPUT%"
